...
export type PublisherInfoFragment = { __typename?: 'Publisher', id: string, title: string, avatar: { __typename?: 'Picture', bucket: string, key: string } } & { ' $fragmentName'?: 'PublisherInfoFragment' };
